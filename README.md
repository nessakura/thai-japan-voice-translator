    ...
    <div class="container">
        ...
        <div class="api-setup" id="apiSetupSection">
            ...
            <div class="warning">
                ...
                💡 <strong>วิธีใช้:</strong> ใส่ API Key → กดบันทึก → เริ่มใช้งานได้เลย!<br>
				☕ <strong>การสนับสนุนของคุณมีความหมายมากครับ หากประสงค์จะช่วยค่ากาแฟให้ผู้พัฒนาในราคา 50 บาท สามารถสร้าง QR-Code ได้ง่ายๆ </strong>
				<a href="https://makubtrader.com/ccdc/promptpay-qr.php" target="_blank">เพียงคลิกที่นี่</a><br>
            </div>
    ...
    <script>
        class BiDirectionalVoiceTranslator {
            ...
            async translateText(sourceText, sourceLang, targetLang) {
                ...
                const API_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash-001:generateContent?key=${this.geminiApiKey}`;
